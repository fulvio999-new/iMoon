        ...
        Row{
            ...
            Button {
                ...
                onClicked: {
                    ...
                    sunPositionAltitudeLabel.text = "Altitude: "+sunPosition.altitude+ " rad <br/> ("+parseFloat(altitudeDegree).toFixed(10)+" degrees)"
                    sunPositionAzimuthLabel.text = "Azimuth: "+parseFloat(sunPosition.azimuth).toFixed(10)+ " rad <br/> ("+parseFloat(azimuthDegree).toFixed(10)+" degrees)"
                    ...
                    moonAltitudeLabel.text = "Altitude: "+moonPosition.altitude + " rad <br/> ("+parseFloat(moonAltitudeDegree).toFixed(10)+" degrees)"

                    moonAzimuthLabel.text = "Azimuth: "+moonPosition.azimuth+ " rad <br/> ("+parseFloat(moonAzimuthDegree).toFixed(10)+" degrees)"

                    moonDistanceLabel.text = "Distance: "+moonPosition.distance + " Km"

                    //parallacticAngle: parallactic angle of the moon in radians
                    parallacticAngleLabel.text = "Parallactic Angle: "+ parseFloat(moonPosition.parallacticAngle).toFixed(10) + " rad <br/> ("+parseFloat(moonParallacticAngleDegree).toFixed(10)+" degrees)"
                    ...
                    moonAngleLabel.text = "Angle: "+moonPhase.angle + " rad <br/> ("+parseFloat(moonAngleDegree).toFixed(10)+" degrees)"
